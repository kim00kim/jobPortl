...
!function (a) {
	a.Parse = a.Parse || {}, a.Parse.VERSION = "js1.3.0"
}(this), function () {
	...
	b.serverURL = "https://api.parse.com", "undefined" != typeof process && process.versions && process.versions.node && (b._isNode = !0), b.initialize = function (a, c, d) {
		...
		var g = {success: e, error: f};
		if (b._useXDomainRequest())return b._ajaxIE8(a, c, d)._thenRunCallbacks(g);
		var h = new b.Promise, i = !1, j = new b.XMLHttpRequest;
		...
		if (e.isDate(a))return {__type: "Date", iso: a.toJSON()};
		...
		if (a instanceof b.File) {
			...
			return {__type: "File", name: a.name(), url: a.url()}
		}
		if (e.isObject(a)) {
			var f = {};
		...
		if ("Pointer" === c.__type && c.className) {
			...
			return e._finishFetch({objectId: c.objectId}, !1), e
		}
		...
		if ("GeoPoint" === c.__type)return new b.GeoPoint({latitude: c.latitude, longitude: c.longitude});
	...
	b.Analytics = b.Analytics || {}, c.extend(b.Analytics, {
		track: function (a, d) {
			...
			}), b._request({route: "events", className: a, method: "POST", data: {dimensions: d}})
		}
	})
}(this), function (a) {
	a.Parse = a.Parse || {};
	...
	b.Config = function () {
		...
		var a = b.localStorage.getItem(b._getParsePath(b.Config._CURRENT_CONFIG_KEY)), c = new b.Config;
		return a && (c._finishFetch(JSON.parse(a)), b.Config._currentConfig = c), c
	}, b.Config.get = function (a) {
		a = a || {};
		var c = b._request({route: "config", method: "GET"});
	...
	b.Events = {
		on: function (a, b, d) {
			...
			if (f = this._callbacks) {
				...
				for (a = a ? a.split(c) : _.keys(f), e = a.shift(); e;)if (g = f[e], delete f[e], g && (b || d)) {
	...
	b.GeoPoint = function (a, d) {
		...
		return navigator.geolocation.getCurrentPosition(function (a) {
			c.resolve(new b.GeoPoint({latitude: a.coords.latitude, longitude: a.coords.longitude}))
		}, function (a) {
			c.reject(a)
	...
	b.ACL = function (a) {
		var d = this;
		if (d.permissionsById = {}, c.isObject(a))if (a instanceof b.User)d.setReadAccess(a, !0), d.setWriteAccess(a, !0); else {
	...
	b.Op = function () {
		...
		_extend: b._extend, _opDecoderMap: {}, _registerDecoder: function (a, c) {
		...
		_initialize: function (a) {
			...
			return {__op: "Add", objects: b._encode(this.objects())}
		}, _mergeWithPrevious: function (a) {
			if (a) {
		...
		_initialize: function (a) {
			...
			return {__op: "AddUnique", objects: b._encode(this.objects())}
		}, _mergeWithPrevious: function (a) {
			if (a) {
				if (a instanceof b.Op.Unset)return new b.Op.Set(this.objects());
				if (a instanceof b.Op.Set)return new b.Op.Set(this._estimate(a.value()));
		...
		_initialize: function (a) {
			...
			return {__op: "Remove", objects: b._encode(this.objects())}
		}, _mergeWithPrevious: function (a) {
			if (a) {
		...
		_initialize: function (a, d) {
			...
			var a = null, b = null, d = this, e = function (a) {
				return {__type: "Pointer", className: d._targetClassName, objectId: a}
			}, f = null;
	...
	b.Promise = function () {
		...
		_isPromisesAPlusCompliant: !1, is: function (a) {
	...
	b.Object = function (a, d) {
		...
		if (e && (a = c.extend({}, e, a)), d && d.collection && (this.collection = d.collection), this._serverData = {}, this._opSetQueue = [{}], this.attributes = {}, this._hashedJSON = {}, this._escapedAttributes = {}, this.cid = c.uniqueId("c"), this.changed = {}, this._silent = {}, this._pending = {}, !this.set(a, {silent: !0}))throw new Error("Can't create an invalid Parse.Object");
		...
		return c = c || {}, b.Object._deepSaveAsync(a, {useMasterKey: c.useMasterKey})._thenRunCallbacks(c)
				...
				return b._request({
					...
					data: {
						requests: c.map(a, function (a) {
							return {method: "DELETE", path: "/1/classes/" + a.className + "/" + a.id}
						})
					}
				})
			}).then(function (c) {
		...
		_existed: !1, initialize: function () {
		}, toJSON: function () {
			...
			a._refreshingCache || (a._refreshingCache = !0, b._objectEach(this.attributes, function (d, e) {
				d instanceof b.Object ? d._refreshCache() : c.isObject(d) && a._resetCacheForKey(e) && a.set(e, new b.Op.Set(d), {silent: !0})
			...
			m._refreshCache();
			var n = [], o = [];
			return b.Object._findUnsavedChildren(m.attributes, n, o), n.length + o.length > 0 ? b.Object._deepSaveAsync(this.attributes, {useMasterKey: h.useMasterKey}).then(function () {
	...
	b.Collection = function (a, b) {
		...
		model: b.Object, initialize: function () {
		}, toJSON: function () {
			...
			if (this.length += g, f = b._isNullOrUndefined(d.at) ? this.models.length : d.at, this.models.splice.apply(this.models, [f, 0].concat(a)), this.comparator && this.sort({silent: !0}), d.silent)return this;
			...
			return e.find({useMasterKey: a.useMasterKey}).then(function (b) {
	...
	b.User = b.Object.extend("_User", {
		_isCurrentUser: !1, _mergeFromObject: function (a) {
			...
			if (c.isString(a) ? (e = a, a = b.User._authProviders[a]) : e = a.getAuthType(), c.has(d, "authData")) {
				...
				}, this.save({authData: f}, g)
			}
			var h = this, i = new b.Promise;
			return a.authenticate({
				success: function (a, b) {
					h._linkWith(a, {authData: b, success: d.success, error: d.error}).then(function () {
						i.resolve(h)
					})
				}, error: function (a, b) {
			...
			var c = this;
			a = a || {};
			var d = b._request({route: "login", method: "GET", useMasterKey: a.useMasterKey, data: this.toJSON()});
			return d.then(function (a, b, d) {
				var e = c.parse(a, b, d);
		...
		logIn: function (a, c, d) {
			...
			return e._finishFetch({username: a, password: c}), e.logIn(d)
		},
		become: function (a, c) {
			c = c || {};
	...
	b.Query = function (a) {
		...
		get: function (a, d) {
			...
			var f = {};
			return d && c.has(d, "useMasterKey") && (f = {useMasterKey: d.useMasterKey}), e.first(f).then(function (a) {
				if (a)return a;
				var c = new b.Error(b.Error.OBJECT_NOT_FOUND, "Object not found.");
				return b.Promise.error(c)
			})._thenRunCallbacks(d, null)
		}, toJSON: function () {
			var a = {where: this._where};
			...
			return f.then(function (a) {
				return c.map(a.results, function (a) {
					var b = new d.objectClass;
					return b._finishFetch(a, !0), b
				})[0]
			})._thenRunCallbacks(a)
		}, collection: function (a, d) {
			return d = d || {}, new b.Collection(a, c.extend(d, {model: this.objectClass, query: this}))
		}, skip: function (a) {
			...
			var d = c.toJSON();
			return d.className = c.className, this._addCondition(a, "$select", {key: b, query: d}), this
		}, doesNotMatchKeyInQuery: function (a, b, c) {
			var d = c.toJSON();
			return d.className = c.className, this._addCondition(a, "$dontSelect", {key: b, query: d}), this
		}, _orQuery: function (a) {
			...
			return c instanceof b.GeoPoint || (c = new b.GeoPoint(c)), d instanceof b.GeoPoint || (d = new b.GeoPoint(d)), this._addCondition(a, "$within", {$box: [c, d]}), this
		}, include: function () {
			var a = this;
	...
	b.History.started = !1, c.extend(b.History.prototype, b.Events, {
		interval: 50, getHash: function (a) {
			...
			b.History.started = !0, this.options = c.extend({}, {root: "/"}, this.options, a), this._wantsHashChange = this.options.hashChange !== !1, this._wantsPushState = !!this.options.pushState, this._hasPushState = !!(this.options.pushState && window.history && window.history.pushState);
	...
	b.Installation = b.Object.extend("_Installation"), b.Push = b.Push || {}, b.Push.send = function (a, c) {
		...
		var d = b._request({route: "push", method: "POST", data: a, useMasterKey: c.useMasterKey});
		return d._thenRunCallbacks(c)
	}
}(this);
